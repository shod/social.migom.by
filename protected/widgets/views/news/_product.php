<div class="post">
    <div class="related"><?= Yii::t('UserNews', 'title:'.$model->name); ?> <a href="<?= $model->link ?><?= $model->entity_id ?>/discussion"><?= ($model->title)? $model->title : Yii::t('Site', 'Новость') ; ?></a><div id="<?= $model->name . '_' . $model->id ?>_delete" class="close ajaxNewDelete">
            </div></div>
        <div class="message">
