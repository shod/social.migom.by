...
<table class="span-10">
	...
	<tr style="background: none repeat scroll 0 0 #F8F8F8;">
		<td><b>Комментарии к продуктам</b></td>
		<td><?= CHtml::link($statistics['commentsProduct'], array('/ads/comments/product')) ?></td>
	</tr>
	<tr style="background: none repeat scroll 0 0 #E5F1F4;">
	...
	<tr style="background: none repeat scroll 0 0 #E5F1F4;">
		<td><b>Пользователи зарег. после билда</b></td>
		<td><?= $statistics['afterBuildSocial'] ?></td>
	</tr>
	<tr style="background: none repeat scroll 0 0 #F8F8F8;">
